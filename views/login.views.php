...
<head>
    ...
    <title>Viens Dindin login</title>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form"  name="login-form" id="login-form" action="login.php">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="connexion" id="connexion" class="form-submit" value="Connexion"/>
                            </div>
                        </form>
                        <div class="social-login">
                            <span class="social-label">Ou se connecter</span>
                            <ul class="socials">
